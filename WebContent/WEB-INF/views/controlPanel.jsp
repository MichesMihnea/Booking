...
<%
				...
				int approval = DBUtils.getApproval(conn, DBUtils.getOwnerId(conn, (String) request.getAttribute("user.name")));
		...
		<div class="row justify-content-center mb-5 mr-5">
				...
				<div class="select-wrap one-third">
					...
					<a href="${pageContext.request.contextPath}/resetPassword">Change
						Password</a>
				</div>
				
				<div class="row justify-content-center mb-5">
						
					<a href="${pageContext.request.contextPath}/resetEmail">Change
						Email</a>
				</div>
				...
				<script>
               		...
               		if(jsAtt == "owner"){ 
               			if('${approval}' == 1){
               				document.getElementById("guests").innerHTML += "<option value=\"0\">Automatic</option> <option value=\"1\" selected=\"selected\">Manual</option>";
               			}else{
               				document.getElementById("guests").innerHTML += "<option value=\"0\" selected=\"selected\">Automatic</option> <option value=\"1\">Manual</option>";
               			}
