      ...
      <div class="container">
        ...
        <div class="container">
                   ...
                   <div class="row justify-content-center mb-3">
					...
					<div class="row justify-content-center mb-3">
                      <div class="textfield-search one-third col-sm-4"><input type="password" class="form-control" placeholder="New Password" name="newPassword" value= "${user.password}"></div>
					</div>
					<div class="row justify-content-center mb-5">
               			<div class="textfield-search one-third col-sm-4"><input type="password" class="form-control" placeholder="Confirm Password" name="confirmPassword" value= "${user.password}"></div>
               		</div>
