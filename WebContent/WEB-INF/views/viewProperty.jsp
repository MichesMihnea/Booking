...
String sql="select virtual_property_id, name from virtual_property where owner_id = ?";
...
int idname= resultSet.getInt(1);
String name = resultSet.getString(2);
session.setAttribute("propertyName", idname);
session.setAttribute("stringName", name);

%> <script>
var jsAtt = '${propertyName}';
var jsAtt2 = '${stringName}';
document.getElementById("aaron-family").innerHTML += "<li><a href= ${pageContext.request.contextPath}/property?name=" + jsAtt + ">" + jsAtt2 + "</a></li>";
</script>
					<%} %>
