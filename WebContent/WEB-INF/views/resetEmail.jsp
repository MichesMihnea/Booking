...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="${pageContext.request.contextPath}/resetEmail">
      <div class="container">
        ...
        <div class="container">
                   ...
                   <div class="row justify-content-center mb-3">
					...
					<div class="row justify-content-center mb-3">
                      <div class="textfield-search one-third col-sm-4"><input type="text" class="form-control" placeholder="New Email" name="newPassword" value= "${user.password}"></div>
					</div>
					<div class="row justify-content-center mb-5">
               			<div class="textfield-search one-third col-sm-4"><input type="text" class="form-control" placeholder="Confirm Email" name="confirmPassword" value= "${user.password}"></div>
               		</div>
