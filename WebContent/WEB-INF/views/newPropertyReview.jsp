...
<!-- This is the New Owner Review page, and it is identical to the New Client Review page.
...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="${pageContext.request.contextPath}/newPropertyReview" enctype="multipart/form-data">
      <div class="container">
      ...
      session.setAttribute("booking", request.getAttribute("booking"));%>
      </form>
    </section>
