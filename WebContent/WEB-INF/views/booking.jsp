...
<!-- This page displays a booking's details, which are fetched from the database
	by the Java code according to the url parameters, which point to the correct booking
      ...
      <div class="container">
        <div class="row justify-content-center mb-4 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2>Your booking for ${propertyName}</h2>
          </div>
        </div>
        <div class="row justify-content-center mb-4 pb-5">
		...
		<script>
			...
			document.getElementById("back").innerHTML += "<a href= ${pageContext.request.contextPath}/viewBookings> Back to my bookings </a>";
		</script>
...
String sql2="select check_in, check_out, price from booking where booking_id = ?";
